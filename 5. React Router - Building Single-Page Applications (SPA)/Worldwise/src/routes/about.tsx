...
export default function AboutPage() {
  return (
    <PageLayout>
      <section className="mx-auto grid max-w-4xl grid-cols-1 items-center justify-center gap-8 text-center sm:h-full sm:grid-cols-2">
        <div className="mt-8 flex flex-col space-y-8 text-left sm:mt-0">
