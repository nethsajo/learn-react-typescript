...
export function Button({
  ...
  const classNames = `inline-flex w-auto items-center justify-center sm:justify-start space-x-2 outline-none font-semibold transition-colors duration-300 ${sizes[size]} ${colors[color]} ${variants[variant]}`;
